...
CREATE TABLE `paseli` (
  ...
  UNIQUE KEY `paseli_rawId_uindex` (`rawId`)
...
/*Table structure for table `sdvx_5_item` */

DROP TABLE IF EXISTS `sdvx_5_item`;

CREATE TABLE `sdvx_5_item` (
  `refId` varchar(16) NOT NULL,
  `type` int(2) NOT NULL,
...
CREATE TABLE `sdvx_5_profile` (
  ...
  `appeal_id` varchar(8) NOT NULL DEFAULT '0',
  ...
  `player_name` varchar(10) NOT NULL DEFAULT 'KONMAI',
  `player_code` varchar(9) NOT NULL,
  `akaname_id` varchar(6) NOT NULL DEFAULT '40002',
  UNIQUE KEY `sdvx_5_profile_refId_uindex` (`refId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='SDVX5的用户基础数据';

/*Table structure for table `sdvx_5_profile_param` */

DROP TABLE IF EXISTS `sdvx_5_profile_param`;

CREATE TABLE `sdvx_5_profile_param` (
...
/*Table structure for table `sdvx_5_score` */

DROP TABLE IF EXISTS `sdvx_5_score`;

CREATE TABLE `sdvx_5_score` (
  `refId` varchar(16) NOT NULL,
  `music_id` int(10) NOT NULL,
  `music_type` int(1) NOT NULL,
  `score` int(8) NOT NULL,
  `clear_type` int(1) NOT NULL,
  `score_grade` int(1) NOT NULL,
  `max_chain` int(5) NOT NULL,
  `critical` int(4) NOT NULL,
  `near` int(4) NOT NULL,
  `error` int(4) NOT NULL,
  `gauge_type` int(4) NOT NULL,
  `effective_rate` int(4) NOT NULL,
  `btn_rate` int(4) NOT NULL,
  `long_rate` int(4) NOT NULL,
  `vol_rate` int(4) NOT NULL,
  `mode` int(1) NOT NULL,
  `notes_option` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sdvx_5_setting` (
  ...
  `lanespeed` int(20) NOT NULL DEFAULT '0',
  `hispeed` int(20) NOT NULL DEFAULT '0',
  `draw_adjust` int(2) NOT NULL DEFAULT '0',
  `p_start` varchar(100) NOT NULL DEFAULT '0',
  `p_end` varchar(100) NOT NULL DEFAULT '0',
