...
from kbinxml_util.bytebuffer import ByteBuffer
from kbinxml_util.format_ids import xml_formats, xml_types
from kbinxml_util.sixbit import pack_sixbit, unpack_sixbit
...
XML_ENCODING = 'UTF-8'
BIN_ENCODING = 'UTF-8'  # windows shift-jis variant
